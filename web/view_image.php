    ...
    <header id="header" class="fixed-top">
        <div class="container-fluid d-flex align-items-center justify-content-lg-between my-header-bg">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="nav-link scrollto active" href="#laptops">Laptops</a></li>
                    <li><a class="nav-link scrollto" href="#Speakers">Speakers</a></li>
                    <li><a class="nav-link scrollto" href="#Power Backups">Power Backups</a></li>
                    <li><a class="nav-link scrollto " href="#Peripherals">Peripherals</a></li>
                    <li><a class="nav-link scrollto " href="#Accessories">Accessories</a></li>
                    <li class="dropdown"><a href="#"><span>Shop</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="#">Laptops</a></li>
                            <li><a href="#">Speakers</a></li>
                            <li><a href="#">Power Backups</a></li>
