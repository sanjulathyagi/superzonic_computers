    ...
    <header id="header" class="fixed-top">
        <div class="container-fluid d-flex align-items-center justify-content-lg-between my-header-bg">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0 ">
                <ul>
                    <li><a class="nav-link scrollto active" href="index.php"><i class="fas fa-home"></i> &nbsp;Home</a></li>
                    ...
                    <li><a class="nav-link scrollto " href="#contact"><i class="fas fa-phone-volume"></i> &nbsp;Contact us</a></li>
                    <li><a class="nav-link scrollto" href="#services"><i class="fas fa-hands-helping"></i> &nbsp;Services</a></li>
                </ul>
