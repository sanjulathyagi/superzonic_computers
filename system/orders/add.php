...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($item_name)) {
        ...
        if ($result->num_rows > 0) {
            $message['item_name'] = "This item name already exist...!";
        }
    }
    ...
    if (empty($message)) {
        ...
        $db = dbConn(); 
        $sql = "INSERT INTO items(item_name,model_id,brand_id,item_category) VALUES ('$item_name','$brand_id','$model_id','$item_category')";
        $db->query($sql);
        $itemID = $db->insert_id;
        $alert=true;
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group ">
                                ...
                                placeholder="Enter item_name"value="<?= @$item_name ?>">
                            </div>
                        </div>
