    ...
    <div class="col-12">
        ...
        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="number" id="quantity_return" name="quantity_return"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <select id="return_type" name="return_type" required class="form-control">
                                            <option value="">--</option>
            ...
            <div class="card-footer ">
                ...
                <button type="submit" class="btn btn-warning btn-sm" value="Handle Returns">Submit</button>
            </div>
            </form>
        </div>
    </div>
