...
$save_path = __DIR__ . '/../../docs/payment_receipt$payment_id.pdf'; // Replace with your desired absolute server path
...
ob_end_clean();
 ...
 echo "Payment receipt saved: <a href='../../docs/payment_receipt$payment_id.pdf'>Download</a>";
 ?>
