                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="address">  Facebook URL
                                                &nbsp;(<i class="fab fa-facebook-f" aria-hidden="true"></i>)</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="telephone"> Twitter URL &nbsp;
                                                (<i class="fab fa-twitter" aria-hidden="true"></i>)</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="mobile"> Linkedin URL
                                                &nbsp;(<i class="fab fa-linkedin" aria-hidden="true"></i>)</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="email">Youtube URL &nbsp;(<i
                                                    class="fab fa-youtube" aria-hidden="true"></i>)</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="email">Instagram URL &nbsp;( <i
                                                    class="fab fa-instagram" aria-hidden="true"></i> )</label>
                                                    <input type="text" id="email" name="email"
                                                        class="form-control form-control-alternative"
                                                        placeholder="email" value="<?= @$email ?>">
                                                    <span class="text-danger"><?= @$message['email'] ?></span>
