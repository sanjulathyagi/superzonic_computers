...
<div class="row">
    <div class="col-12">
    <a href="add.php" class="mb-2 btn btn-warning btn-sm"><i class="fas fa-plus-circle"></i> New </a>
                            ...
                            <td>
                                <div class="mb-1 dropdown no-arrow">
                                    ...
                                    <div class="shadow dropdown-menu dropdown-menu-left animated--fade-in"
                                        ...
                                        <a href="<?= SYS_URL ?>quiz/edit.php?id=<?= $row['id'] ?>"
                                            class="btn btn-warning btn-sm"><i class="fas fa-edit"></i>Edit</a>
                                        <a class="btn btn-danger btn-sm"
                                            href="<?= SYS_URL ?>quiz/delete.php?id=<?= $row['id'] ?>"
