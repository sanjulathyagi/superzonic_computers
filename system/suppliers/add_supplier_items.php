...
$breadcrumb_item_active = "Add Items";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($message)) {
        ...
        foreach ($item_id as $key => $value){  //pass array values
          ...
          $sql = "INSERT INTO supplier_items (supplier_id,item_id,category_id,brand_id) VALUES ('$supplier_id','$value','$category_id','$brand_id')";
            $db->query($sql);
...
<div class="row">
    <div class="col-12">
        <a href="<?= SYS_URL ?>suppliers/supplier_items.php" class="btn bg-warning btn-sm mb-2"><i class="fas fa-arrow-alt-circle-left"></i> View
            supplier items</a>
