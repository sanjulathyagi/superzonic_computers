                            ...
                            <div class="form-group ">
                                ...
                                <select name="item_name" id="item_name" class="form-control" required>
                                    ...
                                    if($result->num_rows>0){
                                        ...
                                        ?>
                                    <option value="<?= $row['id']?>"><?= @$item_name==$row['id']?'selected':'' ?><?= $row['item_name']?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="form-group ">
                                ...
                                <select name="item_category" id="item_category" class="form-control" required>
                                    ...
                                    if($result->num_rows>0){
                                        while ($row = $result->fetch_assoc()) {
                                        ?>
                                    <option value="<?= $row['id']?>"><?= @$item_category==$row['id']?'selected':'' ?><?= $row['item_category']?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="form-group ">
                                ...
                                <select name="brand_id" id="brand_id" class="form-control" required>
                                    ...
                                    if($result->num_rows>0){
                                        while ($row = $result->fetch_assoc()) {
                                        ?>
                                    <option value="<?= $row['id']?>"><?= @$brand_id==$row['id']?'selected':'' ?><?= $row['brand_id']?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="form-group ">
                                ...
                                <select name="model_id" id="model_id" class="form-control" required>
                                    ...
                                    if($result->num_rows>0){
                                        while ($row = $result->fetch_assoc()) {
                                        ?>
                                    <option value="<?= $row['id']?>"><?= @$model_id==$row['id']?'selected':'' ?><?= $row['model_id']?></option>
                                    <?php
                                        }
                                    }
                                    ?>
